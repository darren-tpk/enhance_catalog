...
data_dir = '/home/data/mammoth/'  # redoubt data directory on local
output_dir = main_dir + 'output/mammoth3/'
convert_redpy_output_dir = output_dir + 'convert_redpy/'
redpy_results_dir = main_dir + 'redpy_results/mammoth3/'
PEC_dir = main_dir + 'data/ncedc/'
PEC_file = PEC_dir + 'mammoth_20121001_20130131.xml'
...
campaign_network_list = []
campaign_station_list = []
campaign_channel_list = []
campaign_location_list = []
tolerance = 4e4  # tolerance for boxcar removal from data (as a factor to median)
local = True
client_name = 'NCEDC' # IRIS/NCEDC
add_redpy_pick_to_associated = True
add_campaign_pick_to_associated = False
campaign_starttime = UTCDateTime(2012,10,1)
campaign_endtime = UTCDateTime(2013,2,1)
freqmin = 1
freqmax = 10
