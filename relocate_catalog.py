...
relocatable_catalog_filename = 'relocatable_catalog.xml' # ALSO: sub_catalog.xml, may_swarm.xml
relocate_catalog_output_dir = '/Users/darrentpk/Desktop/GitHub/enhance_catalog/output/mammoth3/growclust/' # '/Users/darrentpk/Desktop/OUTPUT/' #
relocated_catalog_filename = 'growclust_relocated_catalog.xml'
...
raw_vzmodel_filename = 'mammoth_vzmodel2.txt'
...
original_dt_dir = '/Users/darrentpk/Desktop/GitHub/enhance_catalog/output/mammoth3/growclust/master_dt_mth_all_7.cc'
...
for i in range(len(relocated_event_table)):
    ...
    event = Event(origins=[Origin(time=time,latitude=relocated_event_table.lat[i],longitude=relocated_event_table.lon[i],depth=relocated_event_table.dep[i])])
