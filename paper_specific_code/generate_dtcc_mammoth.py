...
for min_cc in [0.4,0.5,0.6,0.7]:
    ...
    if not by_cluster:
        ...
        target_dt_dir = os.getcwd() + '/master_dt_mth_all_' + str(int(min_cc*10)) + '_S.cc'
    ...
    # If we are correlating by cluster
        ...
        # Define source and target cc filepaths
        original_dt_dir = os.getcwd() + '/dt.cc'
        target_dt_dir = os.getcwd() + '/master_dt_mth_clust_' + str(int(min_cc*10)) + '_S.cc'
