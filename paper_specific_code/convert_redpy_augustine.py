...
redpy_results_dir = main_dir + 'redpy_results/augustine5/'
...
redpy_network_list = ['AV','AV','AV','AV','AV','AV','AV']
redpy_station_list = ['AUH','AUI','AUP','AUS','AUW','AUE','AU13']
redpy_channel_list = [['EHZ'],['EHZ'],['EHZ'],['EHZ'],['EHZ'],['EHZ'],['BHZ']]
redpy_location_list = ['--','--','--','--','--','--','--']
campaign_network_list = ['AV','AV','AV','AV']
campaign_station_list = ['AU11','AU12','AU13','AU14','AU15']
campaign_channel_list = [['BHZ'],['BHZ'],['BHZ'],['BHZ'],['BHZ']]
campaign_location_list = ['--','--','--','--']
# campaign_starttime = UTCDateTime()
# campaign_endtime = UTCDateTime()
...
campaign_starttime = UTCDateTime(2005,12,23)
campaign_endtime = UTCDateTime(2006,4,30)
freqmin = 1
freqmax = 10
...
if add_redpy_pick_to_associated:
    ...
    # Commence process
    print('Translating PEC picks for associated cluster events...')
    time_start = time.time()
