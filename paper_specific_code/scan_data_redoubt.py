...
start_time = UTCDateTime(2008, 4, 1, 0, 0, 0)  # start: UTCDateTime(2008, 5, 1, 0, 0, 0)
end_time = UTCDateTime(2009, 9, 1, 0, 0, 0)    # goal: UTCDateTime(2009, 9, 1, 0, 0, 0)
...
reference_stations = ['RDN','REF','RSO']
reference_channels = ['EHZ','EHZ','EHZ']
...
# UTCDateTime(2008,4,1),UTCDateTime(2008,5,1),
time_list = [UTCDateTime(2008,6,1),
             UTCDateTime(2008,7,1),
             UTCDateTime(2008,8,1),
             UTCDateTime(2008,9,1),
             UTCDateTime(2008,10,1),
             UTCDateTime(2008,11,1),
             UTCDateTime(2008,12,1),
             UTCDateTime(2009,1,1),
             UTCDateTime(2009,2,1),
             UTCDateTime(2009,3,1),
             UTCDateTime(2009,4,1),
             UTCDateTime(2009,5,1),
             UTCDateTime(2009,6,1),
             UTCDateTime(2009,7,1),
             UTCDateTime(2009,8,1),
...
for k in range(len(time_list)-1):
    ...
    relocatable_catalog = calculate_relative_magnitudes(relocatable_catalog, tribe, data_dir, noise_window, signal_window,
                                                        min_cc, min_snr, shift_len, tolerance, samp_rate, verbose=True)
