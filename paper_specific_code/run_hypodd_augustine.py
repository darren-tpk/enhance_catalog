...
output_dir = main_dir + 'output/augustine5/relocate_catalog/'
...
if plot_results:
    ...
    ax[0, 0].set_title('LON vs LAT (before hypodd)',fontsize=20)
    ...
    ax[1, 0].set_title('LON vs LAT (after hypodd)',fontsize=20)
    ax[1, 0].set_ylabel('Latitude',fontsize=20)
    ax[1, 0].set_xlabel('Longitude',fontsize=20)
    ...
    ax[0, 1].set_title('LON vs DEP (before hypodd)',fontsize=20)
    ax[0, 1].set_ylabel('Depth (km)',fontsize=20)
    ax[0, 1].set_xlabel('Longitude',fontsize=20)
    ...
    ax[1, 1].set_title('LON vs DEP (after hypodd)',fontsize=20)
    ax[1, 1].set_ylabel('Depth (km)',fontsize=20)
    ax[1, 1].set_xlabel('Longitude',fontsize=20)
    ...
    ax[0, 2].invert_yaxis()
    ax[0, 2].legend(loc='lower right', fontsize=20)
    ax[0, 2].set_title('LAT vs DEP (before hypodd)',fontsize=20)
    ax[0, 2].set_ylabel('Depth (km)',fontsize=20)
    ax[0, 2].set_xlabel('Latitude',fontsize=20)
    ...
    ax[1, 2].set_title('LAT vs DEP (after hypodd)',fontsize=20)
    ax[1, 2].set_ylabel('Depth (km)',fontsize=20)
    ax[1, 2].set_xlabel('Latitude',fontsize=20)
    ...
    ax[0, 2].tick_params(axis='y', labelsize=18)
    ...
    ax[1, 2].tick_params(axis='y', labelsize=18)
    plt.tight_layout()
    # plt.savefig('aug_avo.png')
    fig.show()