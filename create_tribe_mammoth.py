...
mammoth_station_list = ['MINS','MDPB','OMMB','MRD','MDC','MCM','MMP','MLC','MCV','MB01','MB02','MB03','MB05','MB06','MB07','MB08','MB09','MB10','MB11']# redoubt_station_list = ['DFR','NCT','RDDF','RDDR','RDE','RDJH','RDN','RDSO','RDT','RDW','RDWB','RED','REF','RSO','RD01','RD02','RD03']
...
for i, event in enumerate(catalog):
    for pick in reversed(event.picks):
        if pick.waveform_id.station_code not in mammoth_station_list:
