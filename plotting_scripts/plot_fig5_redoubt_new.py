...
# Original catlaog
catalog1 = reader(main_dir + 'output/redoubt5/scan_data/PEC_FI.xml')
plot_title1 = '+t\"Original Catalog (N=%d)\"' % len(catalog1)
# Relocated catalog
catalog2 = reader(main_dir + 'output/redoubt5/relocate_catalog/hypodd_reloc.xml')
...
if plot_temporal:
    ...
    valid_dt_index1 = np.where((times1 > np.datetime64('2008-11-01')) &
                              (times1 < np.datetime64('2009-05-01')))
    invalid_dt_index1 = np.where((times1 < np.datetime64('2008-11-01')) |
                              (times1 > np.datetime64('2009-05-01')))
    valid_dt_index2 = np.where((times2 > np.datetime64('2008-11-01')) &
                              (times2 < np.datetime64('2009-05-01')))
    invalid_dt_index2 = np.where((times2 < np.datetime64('2008-11-01')) |
                              (times2 > np.datetime64('2009-05-01')))
    ...
    with fig.subplot(nrows=1, ncols=1, figsize=("5c", "10c"), autolabel="B"):
        ...
        # Create basemap with correct dimensions
        fig.basemap(region=REGION_NS, projection="X5c/10c", frame=["xa4f1+lDepth", "ya0.05f0.01", "wsNE"],
                    panel=[0, 0])
    ...
    with fig.subplot(nrows=1, ncols=1, figsize=("5c", "5c"), autolabel="D"):
        # Create basemap with correct dimensions
        pygmt.config(GMT_DATA_SERVER="https://oceania.generic-mapping-tools.org")
        fig.basemap(region=[-153.4, -152.1251999, 60.175, 60.805], projection="X5c/5c",
                    frame=["xa0.5f0.25+lLongitude", "ya0.2f0.1+lLatitude", 'wSnE'], panel=[0, 0])
        fig.grdimage(grid=elev_profile_dir + 'redoubt_hillshade_70km.tif', shading=True, cmap="geo",
                     transparency=50)
        ...
        fig.plot(x=[-152.73, -152.2], y=[60.23, 60.23], pen="2p,black")
        fig.text(x=(-152.73 - 152.2) / 2, y=60.25, text="30 km", justify="CB", font="11p,Helvetica,black")
    ...
    if save_figs:
        fig.savefig('/Users/darrentpk/Desktop/figures/paper/newest/figS5_redoubt_time.png')
        fig.savefig('/Users/darrentpk/Desktop/figures/paper/newest/figS5_redoubt_time.pdf')
...
if plot_FI:
    ...
    with fig.subplot(nrows=1, ncols=1, figsize=("10c", "5c"), autolabel="C"):
        ...
        if size_by_magnitude:
            ...
            fig.plot(x=longitude1[invalid_FI_index1], y=depths1[invalid_FI_index1], color="darkgray", cmap=False, style="x0.12c", pen="0.7p,black", transparency=20)
    ...
    fig.show(method="external")
    if save_figs:
        fig.savefig('/Users/darrentpk/Desktop/figures/paper/newest/figS5_redoubt_FI.png')
        fig.savefig('/Users/darrentpk/Desktop/figures/paper/newest/figS5_redoubt_FI.pdf')
...
if plot_relocatable:
    ...
    if save_figs:
        fig.savefig('/Users/darrentpk/Desktop/figures/paper/newest/fig5_redoubt_relocatable.png')
        fig.savefig('/Users/darrentpk/Desktop/figures/paper/newest/fig5_redoubt_relocatable.pdf')
...
if plot_2Dhist:
    ...
    fig.show(method="external")
    if save_figs:
        fig.savefig('/Users/darrentpk/Desktop/figures/paper/newest/figS9_redoubt_2dhist.png')
        fig.savefig('/Users/darrentpk/Desktop/figures/paper/newest/figS9_redoubt_2dhist.pdf')
